package br.com.saodimas.view.components.label;
...
/**
 * JLabel modificada para escrever verticalmente. 
 * @author Zafir Anjum
 * @see {@link <a href="http://www.codeguru.com/java/articles/199.shtml">Java CodeGuru: Vertical JLabel</a>}
 */
...
public class JVerticalLabel extends JLabel {
	...
	public JVerticalLabel(String text, int horizontalAlignment) {
		...
		setUI(new VerticalLabelUI(horizontalAlignment != LEFT));
	}
	...
	public void setHorizontalAlignment(int alignment) {
		setUI(new VerticalLabelUI(alignment != LEFT));
		repaint();
