...
public class VendaTableModel extends AbstractTableModel{
	...
	public static final int PARCELAMENTO   = 4;
	public static final int VALOR          = 5;
	public static final int DESCONTO       = 6;
	public static final int ACRESCIMO      = 7;
	...
	private String[] columnNames = {"Data Venda", "Cliente", "Vendedor","Tipo Pagamento","Parcelamento", "Valor", "Desconto", "Acrescimo", "Total"};
	...
	public Object getValueAt(int row, int col) {
		switch (col) {
			...
			case CLIENTE:         return dataVector.get(row).getCliente().getNome();
