...
public class FaturaTableModel extends DefaultTableModel {
	...
	private ImageIcon iconDestacadoPagamento = new ImageIcon("imagens/seta_abaixo_verde.png", "Já destacado pagamento sem carne");
	private ImageIcon iconPagamentoSemCarne = new ImageIcon("imagens/seta_abaixo_amarela.png", "Pagamento sem carne");
		
	private String[] columnNames = {"", "S/ Carne","Nº.", "Vencimento","Pagamento","Valor","Total","Quitado por", "Parceiro", "Data da Baixa"};
	...
	public Object getValueAt(int row, int col) {
		...
		case  SEM_CARNE: 
			...
			if(dataVector.get(row).getIsPagamentoSemCarne() != null && dataVector.get(row).getIsPagamentoSemCarne().equals("Sim"))
				return iconPagamentoSemCarne; 
			else if(dataVector.get(row).getIsPagamentoSemCarne() != null && dataVector.get(row).getIsPagamentoSemCarne().equals("Destacada"))
				return iconDestacadoPagamento;
			else return null;
	...
	public Class<?> getColumnClass(int column) {
		...
		case SEM_CARNE:     return ImageIcon.class;
