...
public class SpinnerEditorServicoObito extends AbstractCellEditor implements TableCellEditor, ChangeListener {
	final JSpinner spinner = new JSpinner();
	private ServicoObitoVO servico;

	public SpinnerEditorServicoObito() {
		spinner.addChangeListener(this);
		spinner.setModel(new SpinnerNumberModel(1, 1, 99999, 1));	
	}

	public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column){
		servico = (ServicoObitoVO)value;
