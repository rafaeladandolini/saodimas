...
public class ObitoServicoTableModel extends DefaultTableModel {
	...
	private Vector <ServicoObitoVO> dataVector;
	private DecimalFormat formatter = new DecimalFormat("#0.00");
	
	public ObitoServicoTableModel() {
		dataVector = new Vector<ServicoObitoVO>();
	}
    ...
    public void add(ServicoObitoVO s) {
    	dataVector.add(s);
     ...
     */
    public void remove(ServicoObitoVO s) {
    	dataVector.remove(s);
        fireTableDataChanged();
    }
     ...
     */
    public void loadData(List<ServicoObitoVO> listaServicos){
    ...
    @Override
    public Vector <ServicoObitoVO> getDataVector() {
    	return dataVector;
    }
}