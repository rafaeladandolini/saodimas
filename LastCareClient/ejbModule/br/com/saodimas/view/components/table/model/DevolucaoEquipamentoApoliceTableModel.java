...
public class DevolucaoEquipamentoApoliceTableModel extends AbstractTableModel{
	...
	public static final int DATA_DEVOLUCAO = 3;
	public static final int EMPRESTADO_PARA = 4;
	public static final int OBSERVACAO = 5;
		
	private String[] columnNames = {"Equipamento","Data Emprestimo","Data Prevista Devolução", "Data Devolução","Emprestado para","Observação"};
	private Vector <EmprestimoEquipamentoVO> dataVector;
	
	public DevolucaoEquipamentoApoliceTableModel() {
