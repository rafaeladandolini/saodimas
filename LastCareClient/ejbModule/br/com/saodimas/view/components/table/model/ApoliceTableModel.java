...
/**
 * Classe que define a apresentação da Jtable que representa as apólices disponíveis. 
...
public class ApoliceTableModel extends AbstractTableModel{
	...
	private String[] columnNames = {"N. Apólice","Nome do Titular", "Endereço", "Cidade","Plano","Data de Adesão", "Status"};
	...
	/**
	 * Remove todos apólices da tabela.
	 */
    ...
    /**
     * Alimenta a tabela com uma lista de apólices.
