...
public class SelecaoProdutoObitoPanel extends JPanel {
	...
	private JComboBox<ProdutoVO> cbNomes;
	...
	public void setProduto(ProdutoObitoVO produtoObito) {
		...
		if(produtoObito != null){
			...
			txtValorInformado.setText(formatter.format(produtoObito.getValor()));
	...
	private void initialize() {
		...
		cbNomes = new JComboBox<ProdutoVO>();
	...
	//	c.gridy = 2; infProduto.add(lbReferenciaValor, c);
		...
		c.gridy = 2; infProduto.add(lbValorInformado, c);
		...
		c.gridy = 2; infProduto.add(txtValorInformado, c);
