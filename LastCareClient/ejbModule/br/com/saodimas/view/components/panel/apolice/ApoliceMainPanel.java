...
public class ApoliceMainPanel extends CustomLayeredPanel {
	...
	private JButton btRelatorioimpressao;
	...
	public void abrirApoliceDiretoPesquisa()
	{
		barNotificacao.escondeMensagem();
		ApoliceVO apolice = (ApoliceVO)((ApoliceTableModel)tbApolices.getModel()).getSelectedValue(0);
	...
	private void initialize() {
		...
		btRelatorioimpressao = new JButton();
		btRelatorioimpressao.setIcon(new ImageIcon("imagens/imprimir.gif"));
		btRelatorioimpressao.addActionListener(new EventoBotaoControle());
		btRelatorioimpressao.setToolTipText("Imprimir Relatório apólices!");
		
		btRelatorioimpressao.setPreferredSize(DBUTTON);
		btRelatorioimpressao.addKeyListener(tbApolices.getKeyListeners()[0]);
		...
		barControle.add(btRelatorioimpressao);
	}
	...
	private class EventoBotaoControle implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == btRelatorioimpressao){
				try {
