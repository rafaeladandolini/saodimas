...
public class SelecaoProdutoVendaPanel extends JPanel {
	...
	private JComboBox<ProdutoVO> cbProdutos;
	...
	private void initialize() {
		...
		cbProdutos = new JComboBox<ProdutoVO>();
	...
	private class EventoBotaoControle implements ActionListener, ChangeListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == btCancelar) {
				...
				try {
					if (c.getClass() == ClienteEditarMainPanel.class)
						((ClienteEditarMainPanel) c).getIframeVendaProduto().setVisible(false);
				} catch (Exception ex) {
					ex.printStackTrace();
				}
			}
			...
			if (e.getSource() == bAdicionar) {
				...
				((ClienteEditarMainPanel) c).getIframeVenda().adicionarProduto(produtoAdicionar);
				((ClienteEditarMainPanel) c).getIframeVendaProduto().setVisible(false);
			}
		...
		public void stateChanged(ChangeEvent e) {
			if (e.getSource() == spinnerQuantidade) {
				calcularTotal();
			}
