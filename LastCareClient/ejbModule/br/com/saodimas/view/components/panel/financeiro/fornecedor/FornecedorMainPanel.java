...
import br.com.saodimas.view.components.iframe.FornecedorIFrame;
import br.com.saodimas.view.components.panel.BarraNotificacao;
import br.com.saodimas.view.components.panel.CustomLayeredPanel;
import br.com.saodimas.view.components.table.FornecedorTable;
import br.com.saodimas.view.components.table.model.EmpresaCompraTableModel;



@SuppressWarnings("serial")
public class FornecedorMainPanel extends CustomLayeredPanel {
	public static final String FORM_NAME = "Fornecedor"; 
	...
	private FornecedorTable tbEmpresa;
	private FornecedorIFrame iframeEmpresaCompra;
	
	private AbstractButton ultimoComando;
	
	private static final Dimension DBUTTON = new Dimension(30,30);
	
	public FornecedorMainPanel(){
		initialize();
		configure();
	}
	...
	public FornecedorIFrame getIFrameEmpresaCompra() {
	...
	private void initialize() {
		...
		iframeEmpresaCompra = new FornecedorIFrame(){
			@Override
		...
		btNovo.setToolTipText("Cadastra uma nova empresa!");
		...
		btEditar.setToolTipText("Edita os dados de uma empresa!");
		...
		btExcluir.setToolTipText("Remove uma empresa!");
	...
	private void configure() {
		...
		infColaborador.setBorder(BorderFactory.createTitledBorder("Empresas"));
	...
	private class EventoBotaoControle implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == btNovo){
				...
				FornecedorVO dep = (FornecedorVO)model.getSelectedValue(row);
				...
				if (mostraConfirmacao("Confirmação", "Confirma a exclusão do empresa?", JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION){
					int row = tbEmpresa.getSelectedRow();
					EmpresaCompraTableModel model = (EmpresaCompraTableModel)tbEmpresa.getModel();
					FornecedorVO col = (FornecedorVO)model.getSelectedValue(row);
					try{
