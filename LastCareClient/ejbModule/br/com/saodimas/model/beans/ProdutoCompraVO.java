...
public class ProdutoCompraVO implements Serializable {
	...
	public static final String TABELA = "PRODUTO_COMPRA";
	
	public static final String ID_PRODUTO_COMPRA = "ID_PRODUTO_COMPRA";
	public static final String ID_COMPRA = "ID_COMPRA";
	public static final String ID_PRODUTO = "ID_PRODUTO";
	public static final String QUANTIDADE = "QUANTIDADE";
	public static final String VALOR_CUSTO = "VALOR_CUSTO";
