...
public class ProdutoObitoDAOImpl implements ProdutoObitoDAO{

	public void delete(ProdutoObitoVO entity, Connection conn) throws SQLException {
	...
	public List<ProdutoObitoVO> findAll(Connection conn) throws SQLException{
	...
	public void save(ProdutoObitoVO entity, Connection conn) throws SQLException {
		PreparedStatement stmt = null;
	...
	public void update(ProdutoObitoVO entity, Connection conn) throws SQLException {
		PreparedStatement stmt = null;
	...
	private ProdutoObitoVO createVOFromResultSet(ResultSet rs, Connection conn) throws SQLException
	{
	...
	public ProdutoObitoVO findById(Integer id, Connection conn)
			throws SQLException {
	...
	public List<ProdutoObitoVO> getAllProdutoObitoByObito(ObitoVO obito, Connection conn) throws SQLException {
